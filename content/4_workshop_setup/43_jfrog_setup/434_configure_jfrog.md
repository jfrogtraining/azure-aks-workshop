...
3. Execute the script in the Azure Cloud Shell to create Artifactory repositories, Xray watches and policies. This command will take a few minutes to complete.
